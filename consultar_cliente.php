...
if (isset($_GET['id'])){
  $id = $_GET['id'];
  $deletar = mysqli_query($conn, "DELETE FROM clientes WHERE id='$id'");
  if ($deletar){
...
.table{
  ...
  right: 370px;
    ...
    <tr><th>#</th><th>Nome</th><th>Sexo</th><th>Nascimento</th><th>Celular</th><th>Email</th><th>Senha</th><th><a href="http://localhost/cadastrophp/painel.php"> Voltar </a></th></tr>
      ...
      <td><a href="alterar_cliente.php?id=<?php echo $linha['id']; ?>">Editar</a> . <a href="?id=<?php echo $linha['id']; ?>">Excluir</a></td></tr>
