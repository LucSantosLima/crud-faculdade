...
<html>
    ...
    <tr><th>#</th><th>Tipo de produto</th><th>Tamanho da roupa</th><th>Tema do produto</th><th><a href="http://localhost/cadastrophp/painel.php"> Voltar </a></th></tr>
      ...
      <td><a href="alterar_produto(func).php?id=<?php echo $linha['id']; ?>">Editar</a> . <a href="?id=<?php echo $linha['id']; ?>">Excluir</a></td></tr>
