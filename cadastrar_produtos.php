...
<html>
    ...
    <body>
        ...
        <form method="post">
            ...
            <input type="text"  name="produto" class="inputuser" required="" placeholder="Qual produto será cadastrado?"></br>
            </div>
</br>
            <div class="inputbox">
            ...
            <input type="text" name="tema" class="inputuser" required="" placeholder="Qual o tema do produto?"></br>
            </br>
            </div>
