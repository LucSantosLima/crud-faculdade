...
<html>
    ...
    <tr><th>#</th><th>Nome do jogo</th><th>Gênero do jogo</th><th>Desenvolvedora</th><th>Plataforma</th><th>Classificação</th><th><a href="http://localhost/cadastrophp/painel.php"> Voltar </a></th></tr>
      ...
      <td><a href="alterar_jogos(func).php?id=<?php echo $linha['id']; ?>">Editar</a> . <a href="?id=<?php echo $linha['id']; ?>">Excluir</a></td></tr>
